...
def indexDocuments(documents):
    ...
    for data_file in documents:
        with open(data_file) as f:
            ...
            doc_content = f.read()
            indexDocumentForTag(doc_content, docId, inverted_index, 'title', 4)
            indexDocumentForTag(doc_content, docId, inverted_index, 'a', 4)
            indexDocumentForTag(doc_content, docId, inverted_index, 'body', 1)
    return inverted_index  

def indexDocumentForTag(document_content, doc_id, inverted_index, tag, weight): 
    global my_tokenizer
    terms = my_tokenizer.getTokensForTag(document_content, tag)
